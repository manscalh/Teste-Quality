...
class TestCartContinueShopping(unittest.TestCase):
    ...
    def test_CT23_continue_shopping_stardard_user(self):
        
        xpath = "//button[@id='continue-shopping']"
        continue_shopping = self.driver.find_element(by=By.XPATH, value=xpath)
